...
export default function Profile() {
  return (
    <div className="min-h-screen bg-gray-50 pb-20 px-4 pt-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-4 border space-y-2">
        ...
        <p>
          <span className="text-gray-500">Ism</span><br />
          <span className="text-lg font-medium">Aliyev Anvar</span>
        </p>
        <p>
          <span className="text-gray-500">Status</span><br />
          <span className="text-lg font-medium">Oddiy</span>
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-4 border space-y-3">
        ...
        <p className="text-gray-500">
          Hozirgi status: <span className="font-medium text-black">Oddiy</span>
        </p>

        <div className="flex space-x-2">
          <button className="flex-1 bg-black text-white py-2 rounded-md font-semibold">
            Oddiy
          </button>
